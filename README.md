...
#### Descripció: 
###### Hem escollit la web del llistat d'estacions meteorològiques automàtiques de Catalunya: https://www.meteo.cat/observacions/llistat-xema, perquè ens ha semblat que conté dades molt interessants per fer el projecte i a més, hem trobat que el llenguatge de marques està bastant bé estructurat, cosa que ajuda alhora de fer scraping. 
